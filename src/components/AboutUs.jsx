...
const AboutUs = () => {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-b from-black to-blue-700 text-white flex items-center py-10'>
            <div className="px-4 md:px-10 w-full md:w-[1000px] mx-auto">
